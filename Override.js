function main(config) {
  config['proxy-groups'] = [
    ...
    },
    {
      ...
      'include-all': true,
      filter:
        '(?i)美|波特兰|达拉斯|俄勒冈|凤凰城|费利蒙|硅谷|拉斯维加斯|洛杉矶|圣何塞|圣克拉ラ|西雅图|芝加哥|US|United States',
      type: 'url-test',
      interval: 300,
      tolerance: 10,
    },
    ...
    {
      name: '苹果服务',
      icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure@master/IconSet/Color/Apple_2.png',
      type: 'select',
      proxies: [
        'DIRECT',
        '节点选择',
